...
void list_files(vector<int> *ch1,const char *dirname,double & DATA_LUMI,double & DATA_LUMI_UNC, double &PROC_XSEC, double & SUM_GEN_WGT, const char *ext="Tree.root")
{
    ...
    const char dirname[75] = "/home/matheus/cernbox/HHDM/DESY/Data_MET_E_17_files";
...
TFile *newfile= new TFile("/home/matheus/Desktop/tt-triggerEfficiency-DL/datasets/2017/Run2017E.root","recreate");                      //Crio um Arquivo com nome Data_F
