...
TH2D* GetLumiScaledSystSF_2017(TString hist){
	    ...
	    // OLD: 2018 (14.027614284+7.066552169+6.898816878+31.747581871) = 59.740565202
...
void ScaleFactors_syst_lumi()
{
        ...
        TFile* f=new TFile("/home/matheus/Desktop/tt-triggerEfficiency-DL/outputs_and_plotting_script/2018/TriggerSFs_2018_lumi.root","RECREATE");
