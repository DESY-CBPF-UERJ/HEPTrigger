...
if (type == 18 or type == 'all'):
    ...
    # list_varied_SF = ["_NJETSHIGH","_NJETSLOW","_NPVHIGH","_NPVLOW","_METHIGH","_METLOW","_ExNumMu0","_ExNumMu1","_ExNumMu2","_ExNumEl0","_ExNumEl1","_ExNumEl2","_DeltaRZone0","_DeltaRZone1","_DeltaRZone2"]
    # for x in list_varied_SF:
