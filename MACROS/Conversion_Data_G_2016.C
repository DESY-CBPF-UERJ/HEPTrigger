...
void list_files(vector<int> *ch1,const char *dirname,double & DATA_LUMI,double & DATA_LUMI_UNC, double &PROC_XSEC, double & SUM_GEN_WGT, const char *ext="Tree.root")
{
    ...
    const char dirname[75] = "/home/matheus/cernbox/HHDM/DESY/Data_MET_G_16_files";
...
TFile *newfile= new TFile("/home/matheus/Desktop/tt-triggerEfficiency-DL/datasets/2016/Run2016G.root","recreate");                      //Crio um Arquivo com nome Data_F
