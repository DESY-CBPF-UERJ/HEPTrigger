...
void list_files(vector<int> *ch1,const char *dirname,double & DATA_LUMI,double & DATA_LUMI_UNC, double &PROC_XSEC, double & SUM_GEN_WGT, const char *ext="Tree.root")
{
                        ...
                        while (fgets(frase,500,file) != NULL){
                            if ( (7<contador) & (contador< 12) ){
                                ...
                                if (contador == 8){
                                    ...
                                    // std::cout<<"luminosidade: "<<DATA_LUMI<<endl;
                                    //printf("%s \n",frase);  
                                }
                                //PROC_XSEC
                                if (contador == 9){
                                    ...
                                    // std::cout<<"lumi. Uncertainty:  "<<DATA_LUMI_UNC<<endl;
                                    //printf("%s \n",frase);  
                                }
                                //PROC_XSEC
                                if (contador == 10){
    ...
    vector<int> index;
    const char dirname[75] = "/home/matheus/cernbox/HHDM/DESY/TTTo2L2Nu_18_files";
    ...
    std::cout<<"O valor do DATA_LUMI e: "<<DATA_LUMI<<endl; 
    std::cout<<"O valor do PROC_XSEC e: "<<PROC_XSEC<<endl;
    std::cout<<"O valor do SUM_GEN_WGT e: "<<SUM_GEN_WGT<<endl;
...
TFile *newfile= new TFile("/home/matheus/Desktop/tt-triggerEfficiency-DL/datasets/2018/_ttbar.root","recreate");                      //Crio um Arquivo com nome Data_F
